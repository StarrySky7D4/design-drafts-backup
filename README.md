...
| 分库 | 来源可见性 | 主要内容 | 许可 |
| --- | --- | --- | --- |
| [`decentralized-chat-architecture`](repositories/decentralized-chat-architecture/README.md) | 公开 | 系统架构、模块契约、ADR、威胁模型、审查记录及未来匿名覆盖网络方案 | MIT |
| [`ModCptLib`](repositories/ModCptLib/README.md) | 私有，已授权公开备份 | 2026-08-09 历史设计快照；另附 2026-08-28 当前状态与漂移说明 | 参见分库 `LICENSE` |
| [`VSCode_mobile`](repositories/VSCode_mobile/README.md) | 私有，已授权公开备份 | 项目编码方案、架构、安全模型、协议草案、路线图及 ADR；路线图于 2026-08-28 单文件刷新 | 源提交未发现根许可证，参见 `LICENSE_STATUS.md` |
